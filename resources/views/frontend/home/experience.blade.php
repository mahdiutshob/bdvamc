    <div class="experience__area dark__image section-padding">
        <img class="experience__area-shape dark-n" src="{{ asset('frontend/assets/img/shape/experience.png') }}"
            alt="">
        <img class="experience__area-shape light-n" src="{{ asset('frontend/assets/img/shape/experience-dark.png') }}"
            alt="">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 lg-mb-30">
                    <div class="experience__area-image">
                        <img class="experience__area-image-shape left-right-animate"
                            src="{{ asset('frontend/assets/img/shape/dots.png') }}" alt="">
                        <div class="experience__area-image-item">
                            <img src="{{ asset('frontend/assets/img/pages/experience-1.jpg') }}" alt="">
                        </div>
                        <div class="experience__area-image-item mt-65">
                            <img src="{{ asset('frontend/assets/img/pages/experience-2.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6">
                    <div class="experience__area-right">
                        <div class="experience__area-right-title">
                            ...
                            <p>Phasellus vel sollicitudin velit. Fusce consequat pretium ligula vel aliquam. Vestibulum
                                molestie luctus sapien et euismod. Cras convallis, purus in elementum lacinia,</p>
                        </div>
                        <div class="experience__area-right-skill">
                            <div class="experience__area-right-skill-item">
                                <div class="experience__area-right-skill-item-content">
                                    ...
                                    <span class="experience__area-right-skill-item-count text-two"><span
                        ...
                        <a class="btn-two" href="request-quote.html">Get Consulting<i
