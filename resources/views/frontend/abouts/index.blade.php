			...
			<div class="row align-items-center">
				...
				<div class="col-xl-4">
					<div class="about__solution-right t-right xl-t-center">
						...
						<img class="about__solution-right-shape left-right-animate" src="{{asset("frontend/assets/img/shape/about-solution.png")}}" alt="">
					</div>
				</div>
			</div>
		</div>
					...
					<div class="company__history-area dark__image">
						<div class="company__history-area-item">
							<div class="company__history-area-item-left">
								<img src="{{asset("frontend/assets/img/about/history-1.jpg")}}" alt="">
							</div>
						...
						<div class="company__history-area-items">
							...
							<div class="company__history-area-items-right">
								<div class="company__history-area-items-right-image">
									<img src="{{asset("frontend/assets/img/about/history-2.jpg")}}" alt="">
								</div>
							</div>
						</div>
						<div class="company__history-area-item">
							<div class="company__history-area-item-left">
								<div class="company__history-area-item-left-image">
									<img src="{{asset("frontend/assets/img/about/history-3.jpg")}}" alt="">
								</div>
							</div>
							<div class="company__history-area-item-right">
								<div class="company__history-area-item-right-content mb-50 xl-mb-30">
						...
						<div class="company__history-area-items">
							...
							<div class="company__history-area-items-right">
								<div class="company__history-area-items-right-image">
									<img src="{{asset("frontend/assets/img/about/history-4.jpg")}}" alt="">
								</div>
							</div>
						</div>
						<div class="company__history-area-item">
							<div class="company__history-area-item-left">
								<div class="company__history-area-item-left-image">
									<img src="{{asset("frontend/assets/img/about/history-5.jpg")}}" alt="">
								</div>
							</div>
							<div class="company__history-area-item-right">
